...
namespace DataAccess
{
    public class ChartFromStat
    {
        ...
        public ChartFromStat(string pathToLib, string pathToPythonFile,string lottoId,string filePathHistory)
        {
            ...
            try
            {
                pythonClass = engine.Operations.Invoke(scope.GetVariable("get_the_statistics"),lottoId,filePathHistory);
            }
            catch(Exception ex) { }
